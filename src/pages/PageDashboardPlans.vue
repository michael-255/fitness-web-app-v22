...
import { addIcon, chartsIcon, plansPageIcon } from '@/shared/icons'
        ...
        <PageFabMenu
            ...
            :subButtons="[
                ...
                },
                {
                    ...
                    color: 'positive',
                    icon: addIcon,
                    handleClick: () => $q.dialog(PlanServInst.createDialogOptions()),
                },
            ]"
        />

        <PageHeading :headingIcon="plansPageIcon" :headingTitle="PlanServInst.labelPlural" />
